...
// Copied from: https://github.com/azixMcAze/Unity-SerializableDictionary
// Changes:
//  - Put into my own namespace to avoid collisions
//  - Add own specialized classes
//  - Only bringing over this class. Have no need for property drawers (at least yet)
// Complaint: Unity should consider supporting serializable dictionaries by now so we don't have to do this

namespace SuperTiled2Unity.Dictionaries
{
    [Serializable] public class Dictionary_string_string : SuperTiled2Unity.ThirdParty.SerializableDictionary<string, string> { }
    [Serializable] public class Dictionary_Vector3Int_FlipFlags : SuperTiled2Unity.ThirdParty.SerializableDictionary<Vector3Int, FlipFlags> {}
}

namespace SuperTiled2Unity.ThirdParty
{
